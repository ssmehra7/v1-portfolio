...
export const About = () => {
  ...
  return (
    <motion.div
      ...
      id="about"
      ref={ref}
      className="flex items-center justify-center scroll-mt-32"
    >
      <motion.div
      ...
      >
        ...
        <p className="mb-3 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500">
          ...
          <span className="font-medium"> from Delhi Technological University</span>. I have a strong foundation in 
          <span className="font-medium"> full-stack web development</span>. I have developed several projects in MERN Stack which you can find in the below sections. I have proficiency in <span className="underline">JavaScript, TypeScript, C++, Python</span>, and frameworks like <span className="font-medium">React.js, Node.js, Express.js, and Tailwind CSS</span>. I am also familiar with Prisma and PostgreSQL. I am also skilled in databases and creating scalable backend applications.
        </p>
